...
A separate model (anonymized) was trained through 14 iterative rounds of multi-reward GRPO on a 35B-parameter MoE base model. The training used 10 tier-level reward dimensions (50 subdimensions) organized in a 9-tier cognitively-motivated architecture~\citep{zhang2026}:
